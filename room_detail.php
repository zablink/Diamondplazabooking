...
// โหลด amenities
$amenities = $hotel->getRoomAmenities($room_type_id);
$roomAmenities = is_array($amenities) ? $amenities : parseJSON($room['amenities']);
        ...
        <div class="room-main">
            ...
            <div class="features-grid">
                ...
                <div class="feature-item">
                    ...
                    <div>
                        <strong><?= $room['total_rooms'] ?? __('rooms.not_specified') ?> <?php _e('common.rooms'); ?></strong>
            ...
            <form method="GET" action="booking.php" id="bookingForm">
                ...
                <div class="form-group">
                    ...
                    <select name="rooms" id="rooms" required>
                        <?php 
                        $maxRooms = min($room['total_rooms'] ?? 5, 10);
