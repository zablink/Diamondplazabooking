<?php
/*
Plugin Name: Hotel Booking Shortcode
Description: Shortcodes to link WordPress to external booking system (room_detail.php) with Polylang support.
Version: 1.0.0
Author: Over
*/
/**  
...
function hotel_booking_button_styles() {
    ...
    <style>
        ...
        .hotel-booking-button.btn-secondary:hover {
            color: white !important;
        }
